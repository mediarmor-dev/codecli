...
import { OPENAI_API_KEY } from "../config";  // Import API key from config.js
    ...
    try {
      const res = await fetch("https://api.openai.com/v1/chat/completions", {
        ...
        headers: {
          ...
          Authorization: `Bearer ${OPENAI_API_KEY}`,  // Use API key from config.js here
        },
        body: JSON.stringify({
          model: "gpt-4o-mini",
  ...
  return (
    <div className={styles.inputBoxContainer}>
      <div className={styles.inputBox}>
        ...
        <button
          className={
            arrowEnabled ? styles.arrowButtonEnabled : styles.arrowButtonDisabled
          }
          onClick={handleGo}
